...
<g:link controller="relation" action="create" params="['person.id': personInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'relation.label', default: 'Relation')])}</g:link>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="locations"><g:message code="person.locations.label" default="Locations" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: personInstance, field: 'locations', 'errors')}">
...
<g:link controller="location" action="create" params="['person.id': personInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'location.label', default: 'Location')])}</g:link>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="names"><g:message code="person.names.label" default="Names" /></label>
                                </td>
...
<g:link controller="name" action="create" params="['person.id': personInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'name.label', default: 'Name')])}</g:link>
...
<g:link controller="confession" action="create" params="['person.id': personInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'confession.label', default: 'Confession')])}</g:link>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="works"><g:message code="person.works.label" default="Works" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: personInstance, field: 'works', 'errors')}">
                                    <g:select name="works" from="${de.uni_koeln.hki.thaller.Work.list()}" multiple="yes" optionKey="id" size="5" value="${personInstance?.works*.id}" />
                                </td>
                            </tr>
