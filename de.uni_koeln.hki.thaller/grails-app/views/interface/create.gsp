...
<g:if test="${flash.message}">
	...
	<div class="errors"><g:renderErrors bean="${personInstance}"
		as="list" /></div>
</g:hasErrors> <g:hasErrors bean="${personName}">
	<div class="errors"><g:renderErrors bean="${personName}"
		as="list" /></div>
</g:hasErrors> <g:hasErrors bean="${personConfession}">
	<div class="errors"><g:renderErrors bean="${personConfession}"
		as="list" /></div>
		...
		<tbody>
			...
			<tr class="prop">
				<td valign="top" class="name"><label for="lastName"><g:message
					code="name.lastName.label" default="Last Name" /></label></td>
				<td valign="top"
					class="value ${hasErrors(bean: nameInstance, field: 'lastName', 'errors')}">
				<g:textField name="lastName" value="${nameInstance?.lastName}" /></td>
			</tr>

			<tr class="prop">
				<td valign="top" class="name"><label for="birthName"><g:message
					code="name.birthName.label" default="Birth Name" /></label></td>
				<td valign="top"
					class="value ${hasErrors(bean: nameInstance, field: 'birthName', 'errors')}">
				<g:textField name="birthName" value="${nameInstance?.birthName}" />
				</td>
			</tr>

			<tr class="prop">
				<td valign="top" class="name"><label for="firstNames"><g:message
					code="name.firstNames.label" default="First Names" /></label></td>
				<td valign="top"
					class="value ${hasErrors(bean: nameInstance, field: 'firstNames', 'errors')}">
			...
			<tr class="prop">
				<td valign="top" class="name"><label for="title"><g:message
					code="confession.title.label" default="Title" /></label></td>
				<td valign="top"
					class="value ${hasErrors(bean: confessionInstance, field: 'title', 'errors')}">
				<g:textField name="title" value="${confessionInstance?.title}" /></td>
			</tr>

			<tr class="prop">
				<td valign="top" class="name"><label for="start"><g:message
			...
			<tr class="prop">
				<td valign="top" class="name"><label for="name"><g:message
					code="location.name.label" default="Name" /></label></td>
				<td valign="top"
					class="value ${hasErrors(bean: locationInstance, field: 'name', 'errors')}">
				<g:textField name="name" value="${locationInstance?.name}" /></td>
			</tr>

			<tr class="prop">
				<td valign="top" class="name"><label for="description"><g:message
					code="location.description.label" default="Description" /></label></td>
				<td valign="top"
					class="value ${hasErrors(bean: locationInstance, field: 'description', 'errors')}">
				<g:textField name="description"
					value="${locationInstance?.description}" /></td>
			</tr>

			<tr class="prop">
				<td valign="top" class="name"><label for="longitude"><g:message
					code="location.longitude.label" default="Longitude" /></label></td>
				<td valign="top"
					class="value ${hasErrors(bean: locationInstance, field: 'longitude', 'errors')}">
			...
			<tr class="prop">
				<td valign="top" class="name"><label for="latitude"><g:message
					code="location.latitude.label" default="Latitude" /></label></td>
				<td valign="top"
					class="value ${hasErrors(bean: locationInstance, field: 'latitude', 'errors')}">
			...
			<tr class="prop">
				<td valign="top" class="name"><label for="relatedPerson"><g:message
					code="relation.relatedPerson.label" default="Related Person" /></label></td>
				<td valign="top"
					class="value ${hasErrors(bean: relationInstance, field: 'relatedPerson', 'errors')}">
				<g:select name="relatedPerson.id"
					from="${de.uni_koeln.hki.thaller.Person.list()}" optionKey="id"
					value="${relationInstance?.relatedPerson?.id}"
					noSelection="['null': '']" /></td>
			</tr>

			<tr class="prop">
				<td valign="top" class="name"><label for="directRelation"><g:message
					code="relation.directRelation.label" default="Direct Relation" /></label>
				</td>
				<td valign="top"
					class="value ${hasErrors(bean: relationInstance, field: 'directRelation', 'errors')}">
				<g:checkBox name="directRelation"
					value="${relationInstance?.directRelation}" /></td>
			</tr>
			...
			<tr class="prop">
				<td valign="top" class="name"><label for="title"><g:message
					code="work.title.label" default="Title" /></label></td>
				<td valign="top"
					class="value ${hasErrors(bean: workInstance, field: 'title', 'errors')}">
				<g:textField name="title" value="${workInstance?.title}" /></td>
			</tr>

			<tr class="prop">
				<td valign="top" class="name"><label for="subtitle"><g:message
					code="work.subtitle.label" default="Subtitle" /></label></td>
				<td valign="top"
					class="value ${hasErrors(bean: workInstance, field: 'subtitle', 'errors')}">
				<g:textField name="subtitle" value="${workInstance?.subtitle}" /></td>
			</tr>
			<tr class="prop">
				<td valign="top" class="name"><label for="releaseDate"><g:message
