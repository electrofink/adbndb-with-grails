            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="work.workTitle.label" default="Work Title" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: workInstance, field: "workTitle")}</td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="work.persons.label" default="Persons" /></td>
                            
                            <td valign="top" style="text-align: left;" class="value">
                                <ul>
                                <g:each in="${workInstance.persons}" var="p">
