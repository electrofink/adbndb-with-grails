            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="name.person.label" default="Person" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="name.firstName.label" default="First Name" /></td>
