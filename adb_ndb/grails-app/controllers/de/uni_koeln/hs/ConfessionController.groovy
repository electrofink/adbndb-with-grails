		...
		if (confessionInstance) {
			if (params.version) {
				...
				if (confessionInstance.version > version) {
					...
					confessionInstance.errors.rejectValue("version", "default.optimistic.locking.failure", [
						message(code: 'confession.label', default: 'Confession')]
					as Object[], "Another user has updated this Confession while you were editing")
